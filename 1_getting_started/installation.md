...
3. 如无账户，需先注册。点击左下角的 `注册` 按钮，进入注册界面(需要联系开发者获取注册码)。
...
1. 启动软件后，选择 **加密狗登录** 选项卡。
2. 插入加密狗，点击 `验证加密狗` 按钮，进入软件界面。

   ![加密狗登录界面](resources/dongle_login.jpg)

> **注意**：如果在启动软件前插入加密狗，软件会自动验证加密狗并进入软件界面。
